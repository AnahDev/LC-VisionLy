...
[cite_start]Este repositorio contiene el desarrollo de la actividad 3 del Tema 2
...
* [cite_start]**Eslogan del Grupo:** "[Mantenlo Simple]"

##  ¿Como ejecutar los scripts del Lenguaje L (Actividad III)?

[cite_start]Hemos diseñado un DSL conceptual adaptado a operadores del sistema físico simulado de la planta ECO-GRID
...
5. [cite_start]La terminal integrada de VS Code ejecutará de forma automática el análisis léxico y sintáctico del programa, imprimiendo las alertas correspondientes en la interfaz HMI[cite: 119].
